...
class GaussianDiffusion:
    ...
    def p_sample(self, pred_noise, x, t, clip_denoised=True):
        ...
        noise = tf.convert_to_tensor(np.random.normal(size=x.shape), dtype=x.dtype)
        # No noise when t == 0
...
class DiffusionModel(keras.Model):
    ...
    def generate_images(self, num_images=16):
        ...
        samples = tf.convert_to_tensor(np.random.normal(size=(num_images, img_size, img_size, img_channels)), dtype=tf.float32)
